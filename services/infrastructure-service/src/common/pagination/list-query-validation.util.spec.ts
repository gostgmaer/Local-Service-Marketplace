...
import { resolvePagination, validateDateRange, validateMinMaxRange } from "./list-query-validation.util";
...
describe("list-query-validation.util", () => {
	...
	it("rejects invalid min max ranges", () => {
		expect(() => validateMinMaxRange(5, 1, "attempts")).toThrow(BadRequestException);
	});
});
