...
export class ProviderController {
	...
	async createProvider(@Body() createProviderDto: CreateProviderDto, @Req() req: any): Promise<ProviderResponseDto> {
	...
	async uploadProviderProfilePicture(
		...
		const updatedProvider = await this.providerService.updateProvider(id, { profile_picture_url: uploadedFile.url });
	...
	@Get(":id/availability")
	@HttpCode(HttpStatus.OK)
	async getProviderAvailability(@Param("id", StrictUuidPipe) id: string): Promise<any[]> {
		this.logger.info("GET /providers/:id/availability", { context: "ProviderController", provider_id: id });
	...
	@Get(":id/services")
	@HttpCode(HttpStatus.OK)
	async getProviderServices(@Param("id", StrictUuidPipe) id: string): Promise<any[]> {
		this.logger.info("GET /providers/:id/services", { context: "ProviderController", provider_id: id });
