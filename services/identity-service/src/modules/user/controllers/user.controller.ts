...
export class UserController {
	...
	@Patch(":id/suspend")
	@HttpCode(HttpStatus.OK)
	async suspendUser(@Param("id", StrictUuidPipe) id: string, @Body() body: SuspendUserDto): Promise<UserResponseDto> {
	...
	@Patch(":id/activate")
	@HttpCode(HttpStatus.OK)
	async activateUser(@Param("id", StrictUuidPipe) id: string): Promise<UserResponseDto> {
	...
	@Patch(":id/restore")
	@HttpCode(HttpStatus.OK)
	async restoreUser(@Param("id", StrictUuidPipe) id: string): Promise<UserResponseDto> {
	...
	@Delete(":id")
	@HttpCode(HttpStatus.OK)
	async deleteUser(@Param("id", StrictUuidPipe) id: string): Promise<UserResponseDto> {
