...
export class AnalyticsController {
  ...
  async trackActivity(
    ...
    const activity =
      await this.analyticsService.trackActivity(trackActivityDto);
  ...
  async getUserActivity(
    ...
    if (
      !(req as any).user?.permissions?.includes("analytics.view") &&
  ...
  async aggregateYesterdayMetrics() {
    ...
    const metric =
      await this.metricsAggregationService.aggregateYesterdayMetrics();
  ...
  async aggregateMetricsForDate(@Param("date") date: string) {
    ...
    const metric =
      await this.metricsAggregationService.aggregateMetricsForDate(date);
