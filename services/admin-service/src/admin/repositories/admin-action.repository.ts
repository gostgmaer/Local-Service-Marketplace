...
export class AdminActionRepository {
  ...
  async createAdminAction(
    ...
    const query = `
      ...
      VALUES ($1, $2, $3, $4, $5)
      RETURNING id, admin_id as "adminId", action, target_type as "targetType", target_id as "targetId", reason, created_at as "createdAt"
    `;
  ...
  async getAdminActions(
    ...
    const query = `
      SELECT id, admin_id as "adminId", action, target_type as "targetType", target_id as "targetId", reason, created_at as "createdAt"
      FROM admin_actions
