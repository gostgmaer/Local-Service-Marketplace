...
Welcome to Local Service Marketplace! We're excited to have you on board.

Get started:
${name.includes('Provider') ? `
• Complete your provider profile
• Add your services and rates  
• Start receiving customer requests
` : `
• Browse local service providers
• Post your first service request
• Get competitive proposals from pros
`}
...
<body>
  <div class="container">
    ...
    <div class="content">
      <h2>Hi ${name},</h2>
      <p>We're thrilled to have you join our community of service providers and customers.</p>
...
<body>
  <div class="container">
    ...
    <p>Hi ${providerName},</p>
    <div class="alert">
      <strong>Action Required:</strong> A new service request matches your expertise!
    </div>
    <div class="details">
...
<head>
  ...
  <style>
    ...
    .container { max-width: 600px; margin: 0 auto; padding: 20px; }
    .button { display: inline-block; padding: 12px 30px; background: #10b981; color: white; text-decoration: none; border-radius: 5px; margin: 20px 0; }
    .proposal { background: #f3f4f6; padding: 20px; border-radius: 5px; margin: 20px 0; }
    .footer { text-align: center; margin-top: 30px; color: #666; font-size: 12px; }
  </style>
</head>
<body>
  <div class="container">
    ...
    <p>Hi ${customerName},</p>
    <p>Good news! You've received a new proposal for your request:</p>
    <div class="proposal">
      <h3>${requestTitle}</h3>
...
<head>
  ...
  <style>
    body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
    .container { max-width: 600px; margin: 0 auto; padding: 20px; }
    .payment { background: #d1fae5; border-left: 4px solid #10b981; padding: 20px; margin: 20px 0; }
    .button { display: inline-block; padding: 12px 30px; background: #667eea; color: white; text-decoration: none; border-radius: 5px; margin: 20px 0; }
    .footer { text-align: center; margin-top: 30px; color: #666; font-size: 12px; }
  </style>
</head>
