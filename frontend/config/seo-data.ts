...
> = {
  "home-cleaning": {
    ...
    description:
      "Find verified home cleaning professionals near you. Get deep cleaning, regular maid service and more.",
    keywords: [
      "home cleaning",
      "maid service",
      "deep cleaning",
  ...
  plumbing: {
    ...
    description:
      "Book licensed plumbers for pipe repair, tap installation, bathroom fitting and plumbing emergencies.",
    keywords: [
      "plumber",
      "plumbing services",
      "pipe repair",
  ...
  electrical: {
    ...
    description:
      "Hire certified electricians for wiring, switch board repair, fan installation and electrical work.",
    keywords: [
      "electrician",
      "electrical repair",
      "wiring",
  ...
  carpentry: {
    ...
    description:
      "Find expert carpenters for furniture making, door repair, modular kitchen and woodwork.",
    keywords: [
      "carpenter",
      "carpentry",
      "furniture",
  ...
  painting: {
    ...
    description:
      "Book professional painters for interior, exterior and texture painting at best prices.",
    keywords: [
      "painter",
      "painting service",
      "wall painting",
  ...
  "pest-control": {
    ...
    description:
      "Book professional pest control for cockroach, termite, bed bugs and mosquito treatment.",
    keywords: [
      "pest control",
      "termite treatment",
      "cockroach control",
  ...
  "ac-repair": {
    ...
    description:
      "Get your AC serviced or repaired by certified technicians. All brands covered.",
    keywords: [
      "AC repair",
      "AC service",
  ...
  "appliance-repair": {
    ...
    description:
      "Book washing machine, refrigerator, microwave and appliance repair at home.",
    keywords: [
  ...
  "moving-packing": {
    ...
    description:
      "Trusted packers and movers for home shifting, office relocation and transport.",
    keywords: [
      "packers and movers",
      "home shifting",
      "office relocation",
  ...
  landscaping: {
    ...
    description:
      "Book professional gardeners for lawn mowing, garden design and maintenance.",
    keywords: [
      "landscaping",
      "gardening",
      "lawn mowing",
  ...
  "beauty-wellness": {
    ...
    description:
      "Book home salon services — facial, waxing, hair care and more delivered at your doorstep.",
    keywords: [
      "home salon",
      "beauty services",
      "facial at home",
  ...
  tutoring: {
    ...
    description:
      "Find qualified home tutors for all subjects, competitive exams and skill development.",
    keywords: [
      "home tutor",
      "tutoring",
      "private tutor",
  ...
  photography: {
    ...
    description:
      "Hire professional photographers for weddings, events, portraits and product photography.",
    keywords: [
      "photographer",
      "wedding photography",
      "event photography",
  ...
  security: {
    ...
    description:
      "Book CCTV installation, security guards and home surveillance at competitive prices.",
    keywords: [
      "security services",
      "CCTV installation",
      "security guard",
