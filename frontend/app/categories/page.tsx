      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-16">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            Browse all service categories and find the right professional for
            your needs
          </p>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {filtered.map((cat: any, idx: number) => (
              ...
              >
                <div
                  className={`rounded-xl border p-6 text-center transition-all hover:shadow-md hover:-translate-y-1 ${CATEGORY_COLORS[idx % CATEGORY_COLORS.length]}`}
                >
          ...
          <div className="space-y-3">
            {filtered.map((cat: any, idx: number) => (
              ...
              >
                <div
                  className={`flex items-center gap-4 rounded-xl border p-5 transition-all hover:shadow-md ${CATEGORY_COLORS[idx % CATEGORY_COLORS.length]}`}
                >
