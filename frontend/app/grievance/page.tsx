  ...
  return (
    <Layout>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(grievanceJsonLd) }}
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-xl p-6 flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 dark:text-amber-400">
                Rule 3(2)(b) of the IT (Intermediary Guidelines and Digital
                Media Ethics Code) Rules, 2021, requires every intermediary to
                designate a Grievance Officer and display their name and contact
                details prominently on its website / app. This page fulfils that
                obligation.
              </p>
            </div>
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-0.5">
                      Dedicated grievance inbox — monitored Monday–Friday, 9
                      AM–6 PM IST
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-primary-600 dark:text-primary-400 hover:underline text-sm font-medium"
                    >
                      {process.env.NEXT_PUBLIC_GRIEVANCE_PHONE ||
                        "+91 80456 78900"}
                    </a>
                    <p className="text-xs text-gray-400 mt-0.5">
                  ...
                  <div>
                    ...
                    <address className="not-italic text-sm text-gray-700 dark:text-gray-300">
                      {process.env.NEXT_PUBLIC_COMPANY_ADDRESS || (
                        <>
                          Local Service Marketplace Private Limited
                          <br />
                          Grievance Officer, 4th Floor, Tech Park,
                          <br />
          ...
          <section>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={title}
                  className={`rounded-xl p-6 border border-gray-200 dark:border-gray-700 ${bg}`}
                >
            ...
            <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
              <strong>Note:</strong> Complaints related to removal of content
              that exposes private sexual material will be resolved within 24
              hours, as mandated under IT Rules 2021.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6">
              You may submit your grievance through any of the following
              channels:
            </p>
              ...
              {[
                {
                  ...
                  detail: (
                    <>
                      ...
                      <em>"Grievance — [Your Registered Email]"</em>.
                    </>
                  ),
                },
                {
                  ...
                  detail:
                    "Call us during business hours. Provide your registered mobile number for verification.",
                },
                {
                  step: "3",
                  title: "Send a Written Notice",
                  detail:
                    "You may send a signed grievance letter to our postal address above (registered / speed post recommended for legal purposes).",
                },
              ...
              {[
                {
                  ...
                  desc: "Account suspension, login issues, or unauthorised access to your account.",
                },
                {
                  title: "Transaction Disputes",
                  desc: "Payment failures, refund delays, escrow disputes, or overcharging.",
                },
                {
                  title: "Provider / Service Quality",
                  desc: "Fraudulent listings, fake reviews, or poor service delivery.",
                },
                {
                  title: "Personal Data & Privacy",
                  desc: "Data deletion requests, data breach concerns, or DPDP Act 2023 rights.",
                },
                {
                  title: "Harmful / Illegal Content",
                  desc: "Requests for removal of content violating IT Rules, obscene material, or defamatory content.",
                },
                {
                  title: "Discrimination & Harassment",
                  desc: "Platform-facilitated harassment, discriminatory conduct, or hate speech.",
                },
              ].map(({ title, desc }) => (
                <div
                  key={title}
          ...
          <section>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
              ...
              have the following rights regarding your personal data processed
              by us:
            </p>
              ...
              {[
                {
                  ...
                  desc: "Know what personal data we hold about you and how it is used.",
                },
                {
                ...
                },
                {
                  ...
                  desc: "File a complaint with our Grievance Officer or escalate to the Data Protection Board of India.",
                },
                {
                  right: "Right to Nominate",
                  desc: "Nominate another individual to exercise your rights in the event of death or incapacity.",
                },
                {
                  right: "Withdrawal of Consent",
                  desc: "Withdraw consent to process your personal data at any time, subject to lawful requirements.",
                },
              ].map(({ right, desc }) => (
          ...
          <section>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              ...
              Grievance Officer within the stipulated time, you may escalate
              your complaint to:
            </p>
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-5">
                ...
                <span className="ml-4 text-sm text-gray-500">
                  Helpline: 1800-11-4000 or 14404
                </span>
              </div>
            </div>
          </section>
