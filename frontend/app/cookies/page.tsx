...
const cookiesJsonLd = {
  ...
  description:
    "Learn how Local Service Marketplace uses cookies to improve your experience.",
  isPartOf: {
    "@type": "WebSite",
          ...
          <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-gray-700 dark:text-gray-300 mb-0">
                    This Cookie Policy explains how Local Service Marketplace
                    uses cookies and similar tracking technologies when you
                    visit our website. For more information about how we handle
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                cookies remain on your device after you close your browser,
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                website, such as which pages are most popular. This helps us
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                (such as your username, language, or theme preference) and
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2 mb-6">
                <li>
                  ...
                  to control cookies through their settings. To find out more
                ...
                <li>
                  <strong>Cookie Consent Tool:</strong> You can manage your
                  cookie preferences using our cookie consent tool that appears
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 p-4 mb-6">
                <div className="flex">
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300 mb-0">
                    Please note that if you disable cookies, some features of
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                ...
                signals to websites that you do not want your online activity
                tracked. Currently, there is no uniform standard for how DNT
                signals should be interpreted. We do not currently respond to
                DNT signals.
              </p>
            </section>
