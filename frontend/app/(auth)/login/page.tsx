				...
				<div className='flex items-center justify-center space-x-2 text-sm'>
					...
					<div
						className={`flex items-center ${
							step === "authenticate" ? "text-green-600 dark:text-green-400"
							: loginMethod ? "text-blue-600 dark:text-blue-400"
							: "text-gray-400"
						}`}>
						<span
							className={`w-6 h-6 rounded-full flex items-center justify-center ${
								step === "authenticate" ? "bg-green-600 text-white"
								: loginMethod ? "bg-blue-600 text-white"
								...
								<div className='flex gap-2 justify-between'>
									...
									{otpTimer > 0 && (
										<div className='flex items-center justify-center w-14 h-14 rounded-lg bg-gray-100 dark:bg-gray-700'>
											<span className='text-sm font-medium text-gray-600 dark:text-gray-400'>{otpTimer}s</span>
										</div>
									)}
								</div>
