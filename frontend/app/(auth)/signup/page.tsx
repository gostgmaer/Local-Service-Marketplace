...
export default function SignupPage() {
	...
	const {
		...
		defaultValues: { email: "", password: "", name: "", userType: "customer", phone: "" },
	});
						...
						<div>
							...
							<select
								...
								className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 dark:bg-gray-800 dark:text-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors ${
									errors.userType ? "border-red-500 focus:ring-red-500" : "border-gray-300 dark:border-gray-600"
								}`}>
										...
										<div
											...
											className={`h-1.5 flex-1 rounded transition-colors ${
												level <= passwordStrength ?
													passwordStrength === 4 ? "bg-green-500 dark:bg-green-400"
													: passwordStrength === 3 ? "bg-yellow-500 dark:bg-yellow-400"
