  ...
  "home-cleaning": [
    {
      ...
      a: "Home cleaning starts from ₹299 for a 1BHK. Prices vary based on the size of your home and type of cleaning (regular vs deep cleaning).",
    },
    {
      q: "Are cleaning materials included?",
      a: "Most professionals bring their own cleaning supplies and equipment. You can confirm this when booking.",
    },
    {
      q: "How many hours does a cleaning session take?",
      a: "A standard cleaning session takes 2-4 hours depending on the size of your home. Deep cleaning may take 4-6 hours.",
    },
  ],
  plumbing: [
    {
      q: "How much does a plumber charge per visit?",
      a: "Plumber visit charges start from ₹199. Labour charges for repairs depend on the complexity of the work.",
    },
    {
      q: "How soon can a plumber arrive?",
      a: "For emergency plumbing, technicians can arrive within 1-2 hours in most cities. Standard bookings are scheduled same-day or next-day.",
    },
    {
      q: "Are repair materials included in the price?",
      a: "Labour is included. Material costs (pipes, fittings) are charged separately and the plumber will inform you upfront.",
    },
  ],
  electrical: [
    {
      q: "What does an electrician visit cost?",
      a: "Electrician visit charges start from ₹149. Work charges depend on the task — switch replacement, wiring or fan installation.",
    },
    {
      q: "Can electricians handle emergency power failures?",
      a: "Yes, emergency electricians are available 24/7 in major cities. For emergency bookings, use the urgent request feature.",
    },
    {
      q: "Are all electricians certified?",
      a: "Yes, all electricians on our platform undergo license and background verification before onboarding.",
    },
  ],
};
...
const DEFAULT_FAQS = [
  {
    ...
    a: "Post your requirement, receive multiple quotes from verified professionals, compare and accept the best offer.",
  },
  {
    q: "Are service providers verified?",
    a: "Yes, all providers undergo background checks, identity verification and license validation before joining the platform.",
  },
  {
    q: "What if I am not satisfied with the service?",
    a: "We offer a satisfaction guarantee with free rework or refund through our dispute resolution process.",
  },
];
        ...
        <div className="container-custom py-8">
          ...
          <div className="mb-10">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                href={`/search?q=${encodeURIComponent(serviceData.name)}&location=${cityData.name}`}
              >
