...
export default function AvailabilityPage() {
  ...
  const updateMutation = useMutation({
    mutationFn: async (availability: AvailabilitySlot[]) => {
      ...
      const response = await apiClient.patch(
        `/providers/${provider.id}/availability`,
        {
          availability,
        },
      );
  ...
  return (
    <ProtectedRoute
      requiredPermissions={[Permission.PROVIDER_AVAILABILITY_MANAGE]}
    >
      <Layout>
        <div className="container-custom py-12">
          {/* Header */}
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Button
                  variant="outline"
                  onClick={() => setQuickSchedule("full_week")}
                >
                  <Calendar className="h-4 w-4 mr-2" />
                  Full Week (7 days)
                </Button>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                  ...
                  <p className="text-sm mt-1">
                    Click "Add Slot" or choose a quick schedule template
                  </p>
                </div>
              )}
            </CardContent>
