    ...
    <Layout>
      <div className="container-custom py-12 max-w-2xl">
        <Link
          ...
          className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 hover:text-primary-600 mb-6"
        >
            ...
            >
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg p-4">
                <p className="text-sm text-amber-800 dark:text-amber-300">
                  ...
                  payments for this job until the dispute is resolved. Please
                  ensure you have tried to resolve the issue directly with the
                  provider first.
                </p>
              </div>
