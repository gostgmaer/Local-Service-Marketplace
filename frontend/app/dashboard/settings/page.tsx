      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {settingsCards.map(
            ({ href, icon: Icon, title, description, color, bg }) => (
              ...
              >
                <div
                  className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center ${bg}`}
                >
        ...
        <div className="mt-6 p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Keep your password strong and enable notifications so you never miss
            an update on your service requests.
          </p>
        </div>
      </div>
    </SettingsLayout>
