...
export default function EarningsPage() {
  ...
  const isLoading =
    providerLoading || earningsLoading || transactionsLoading || payoutsLoading;
  ...
  const sortedTransactions = useMemo(() => {
    ...
    list.sort((a, b) => {
      ...
      if (
        ...
        sortField === "platform_fee" ||
        sortField === "provider_amount"
      ) {
      ...
      return (
        String(a.status || "").localeCompare(String(b.status || "")) * direction
      );
    });
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Derived from completed, pending, and refunded payment
                        records
                      </p>
                    </div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      {payouts?.length || 0} entries
                    </p>
                  </div>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <select
                        value={sortField}
                        onChange={(e) =>
                          handleSort(e.target.value as TransactionSortField)
                        }
                ...
                <CardContent>
                  <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-sm mt-2">
                      Configure bank accounts and payment preferences
                    </p>
                  </div>
                </CardContent>
              </Card>
