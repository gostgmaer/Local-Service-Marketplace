...
const AnalyticsCharts = dynamic(
  () =>
    import("@/components/features/analytics/AnalyticsCharts").then((m) => ({
      default: m.AnalyticsCharts,
    })),
  {
    ssr: false,
    loading: () => (
      <div className="h-64 animate-pulse bg-gray-100 dark:bg-gray-800 rounded-2xl mb-6" />
    ),
  },
);
            ...
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                ...
                <StatCard
                  ...
                  icon={Activity}
                  trend={
                    (disputeStats?.byStatus?.open ?? 0) > 5 ? "up" : "neutral"
                  }
                />
                <StatCard
                  ...
                  icon={CreditCard}
                  trend={
                    (paymentStats?.byStatus?.failed ?? 0) > 0
                      ? "down"
                      : "neutral"
                  }
                />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                ...
                <Card>
                  <CardContent className="p-6">
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                      <Briefcase className="h-5 w-5 text-primary-500" /> Jobs by
                      Status
                    </h3>
                    <div className="space-y-3">
                      {Object.entries(jobStats?.byStatus ?? {}).map(
                        ([status, count]) => {
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                      <Calendar className="h-5 w-5 text-primary-500" /> Daily
                      Metrics
                    </h3>
                        ...
                        <thead>
                          <tr className="border-b border-gray-200 dark:border-gray-700">
                            {[
                              ...
                              <th
                                key={h}
                                className="text-left py-2 px-3 text-gray-600 dark:text-gray-400 font-medium"
                              >
                                {h}
                              </th>
                            ))}
