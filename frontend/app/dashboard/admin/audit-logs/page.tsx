...
function prettifyAction(action: string) {
  ...
  return verb
    ? action.replace(new RegExp(verb, "i"), ACTION_VERBS[verb])
    : action;
}
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Track all administrative and system actions
              </p>
            </div>
            <Button
              variant="outline"
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-gray-800">
                      {filtered.map((log) => (
                        ...
                        >
                          ...
                          <span>
                            <span
                              className={`inline-flex px-2 py-0.5 rounded text-xs font-medium capitalize ${entityColor(log.entity)}`}
                            >
                              {log.entity}
                            </span>
                          </span>
                          <span
                            className="font-mono text-xs text-gray-500 dark:text-gray-400 truncate"
                            title={log.entity_id}
                          >
