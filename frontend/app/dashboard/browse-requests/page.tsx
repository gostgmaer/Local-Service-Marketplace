...
export default function BrowseRequestsPage() {
  ...
  const providerNotVerified =
    isProviderUser && provider && provider.verification_status !== "verified";
            ...
            <>
              ...
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400">
                  Find new opportunities and submit proposals
                </p>
              </div>
                          ...
                          <div className="flex-1">
                            ...
                            {request.proposal_count > 0 && (
                              <div className="text-sm text-gray-500 dark:text-gray-400">
                                {request.proposal_count} proposal
                                {request.proposal_count !== 1 ? "s" : ""}{" "}
                                submitted
                              </div>
                            )}
                          </div>
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Request #
                    {proposalTargetRequest.display_id ||
                      proposalTargetRequest.id.substring(0, 8)}
                  </p>
                </div>
                <button
