...
export default function SearchPage() {
  ...
  const { data: providersData, isLoading: providersLoading } = useQuery({
    ...
    enabled:
      !!debouncedQuery && (activeTab === "all" || activeTab === "providers"),
  });
  ...
  const { data: requestsData, isLoading: requestsLoading } = useQuery({
    ...
    enabled:
      !!debouncedQuery && (activeTab === "all" || activeTab === "requests"),
  });
  ...
  const totalResults =
    providers.length + filteredRequests.length + filteredCategories.length;
                ...
                <section>
                  ...
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    {(activeTab === "all"
                      ...
                      <Link
                        key={provider.id}
                        href={`/providers/${provider.user_id || provider.id}`}
                      >
