...
const features: Array<{
  ...
  },
  {
    title: "Real Reviews",
    description:
      "Read authentic reviews from verified customers. Only real job completions can leave feedback.",
    Icon: Star,
  ...
  },
  {
    title: "24/7 Support",
    description:
      "Our dedicated customer support team is available around the clock to resolve any concerns.",
    Icon: Headphones,
  ...
  },
  {
    title: "Local Experts",
    description:
      "Connect with professionals in your neighborhood who understand local requirements and codes.",
    Icon: MapPin,
  ...
  },
  {
    ...
    description:
      "All providers carry liability insurance. Jobs are covered by our platform protection guarantee.",
    Icon: ShieldIcon,
    iconBg: "bg-primary-100 dark:bg-primary-900/40",
    iconColor: "text-primary-600 dark:text-primary-400",
  },
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Most requests receive 3-5 proposals within 24 hours. Urgent requests can get responses within 1-2 hours.",
  },
  {
    ...
    <Layout>
      ...
      <div className="bg-white dark:bg-gray-950">
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-36 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <h1 className="font-heading text-5xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-7xl leading-tight">
                Your <span className="gradient-text">Local Service</span>
                <br />
                Marketplace
              </h1>
              <p className="mt-6 text-xl leading-8 text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                Connect with verified, licensed professionals in your
                neighborhood. From home repairs to lawn care, find trusted
                experts for any job. Post your request free, get multiple
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
              {stats.map((stat) => (
                ...
                >
                  ...
                  <div className="mt-2 text-sm md:text-base text-primary-100">
                    {stat.label}
                  </div>
                </div>
              ))}
            ...
            <div className="mt-10 text-center">
              <p className="text-primary-100 text-sm">
                🎉 1,000+ jobs completed this week • 500+ new providers joined
                this month
              </p>
            </div>
          </div>
              ...
              >
                ...
                >
                  <CardContent className="flex flex-col items-center text-center p-6">
                    ...
                    <p className="mt-2.5 text-xs font-semibold text-primary-600 dark:text-primary-400">
                      {category.jobs}
                    </p>
                  </CardContent>
                </Card>
        ...
        <div className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="font-heading text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-100">
                How It Works
              </h2>
              <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
                Simple, transparent, and secure process for customers and
                providers
              </p>
            </div>
            ...
            <div className="mt-16">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Get your project done in three easy steps
                </p>
              </div>
              ...
              >
                <CardContent className="p-8">
                  <div className="flex flex-col">
                    <div
                      className={`flex h-12 w-12 items-center justify-center rounded-xl ${feature.iconBg} mb-5`}
                    >
                      <feature.Icon
          ...
          <div className="mt-20 bg-gradient-to-r from-primary-50 to-accent-50 dark:from-primary-900/20 dark:to-accent-900/20 rounded-3xl p-12 dark:border dark:border-gray-700">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Best Local Service Platform 2025
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Your money held safely until job completion
                </p>
              </div>
              <div>
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8 relative">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mt-6 text-lg text-primary-100 leading-relaxed max-w-2xl mx-auto">
                Join 15,000+ trusted professionals earning more with our
                platform. Get matched with ready-to-hire customers in your area.
                Set your own rates, choose your jobs, and get paid fast.
              </p>
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link href="/signup">
                  <Button
              ...
              <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="bg-white/10 rounded-xl p-6 border border-white/15">
                  ...
                  <div className="text-sm font-semibold text-primary-100 mb-1">
                    To Join
                  </div>
          ...
          <div className="mx-auto mt-16 grid max-w-6xl gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 italic leading-relaxed mb-6">
                  "Found an amazing plumber within 2 hours! He fixed my
                  emergency leak the same day. The proposal system made it super
                  easy to compare prices. Best platform for home services!"
                </p>
            ...
            >
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 italic leading-relaxed mb-6">
                  ...
                  I get steady work, the payment system is reliable, and
                  customers are pre-vetted. Highly recommend to fellow
                  contractors!"
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                      Licensed Electrician • 3,200+ jobs
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            >
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 italic leading-relaxed mb-6">
                  "The background checks gave me total peace of mind. Every
                  provider is verified and insured. I've hired cleaners,
                  painters, and movers - all excellent! This is my go-to now."
                </p>
                <div className="flex items-center gap-3">
        ...
        <div className="bg-white dark:bg-gray-950 py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="text-center">
                <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-2xl p-8 mb-4 dark:border dark:border-green-800/30">
                  <div className="text-5xl font-bold text-accent-600 dark:text-accent-400 mb-2">
                    98.7%
                  </div>
                  <div className="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wide">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="text-center md:text-left">
                  ...
                  <div className="text-xs text-gray-400">
                    Rated #1 by customers 4 years running
                  </div>
                </div>
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="text-xs text-gray-400">
                    Average 2.3 hour quote turnaround
                  </div>
                </div>
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="text-xs text-gray-400">
                    Providers keep 95% vs 70-80% elsewhere
                  </div>
                </div>
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="text-xs text-gray-400">
                    Multi-step vetting &amp; ongoing monitoring
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto items-center opacity-70 dark:opacity-60">
              <div className="text-center">
                <div className="font-bold text-gray-700 dark:text-gray-400 text-sm mb-1">
                  2024 Best Of
                </div>
                ...
                {faqs.map((faq, index) => (
                  ...
                  >
                    <CardContent className="p-7">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed ml-9">
                        {faq.answer}
                      </p>
                    </CardContent>
                  </Card>
        ...
        <div className="bg-white dark:bg-gray-950 py-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                We've built multiple layers of protection to ensure every job
                goes smoothly
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
              <Card className="border-2 hover:border-primary-400 dark:hover:border-primary-500 transition-all hover:shadow-elevated dark:bg-gray-900 dark:border-gray-800">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    Funds held in escrow until job completion. Only release
                    payment when you're 100% satisfied with the work.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 hover:border-primary-400 dark:hover:border-primary-500 transition-all hover:shadow-elevated dark:bg-gray-900 dark:border-gray-800">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    All providers undergo identity verification and background
                    screening before they can accept jobs.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 hover:border-primary-400 dark:hover:border-primary-500 transition-all hover:shadow-elevated dark:bg-gray-900 dark:border-gray-800">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    Bank-level encryption, secure messaging, and data
                    protection. Your privacy and security always come first.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 hover:border-primary-400 dark:hover:border-primary-500 transition-all hover:shadow-elevated dark:bg-gray-900 dark:border-gray-800">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                    Not happy? We'll work with you and the provider to make it
                    right or help you find a replacement.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="text-xl text-blue-100 leading-relaxed mb-10">
                Join 100,000+ satisfied customers and 15,000+ verified
                professionals. Post your first request for free today and get
                matched with trusted local experts.
              </p>
