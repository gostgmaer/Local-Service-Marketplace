...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    keywords: [
      "AC service India",
      "air conditioner maintenance India",
      "AC repair cost India",
      "summer home tips",
    ],
  },
  {
    ...
    keywords: [
      "pest control India",
      "termite treatment India",
      "bed bug treatment India",
      "cockroach control",
    ],
  },
  {
  ...
  },
  {
    ...
    keywords: [
      "verify service provider India",
      "safe hiring tips India",
      "how to check plumber credentials",
