        ...
        <div className="container-custom py-8 md:py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Book verified, background-checked local professionals for all your
              home service needs in {city.name}. Compare quotes and hire with
              confidence.
            </p>
          </div>
          ...
          <div className="p-8 bg-primary-50 dark:bg-primary-900/20 rounded-2xl text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Post your request for free and get quotes from verified local
