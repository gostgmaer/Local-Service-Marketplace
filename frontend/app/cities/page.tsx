    ...
    <Layout>
      ...
      <div className="bg-white dark:bg-gray-950 min-h-screen">
        <div className="container-custom py-8 md:py-12">
          <Breadcrumb
            items={[{ label: "Cities", href: "/cities" }]}
            className="mb-6"
          />
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Trusted, verified service providers in {INDIA_CITIES.length}+
              cities across India. Book home cleaning, plumbers, electricians,
              carpenters and more — instantly.
            </p>
          </div>
