...
const PROVIDER_STEPS = ["welcome", "verify-contact", "profile", "services", "availability", "complete"] as const;
							...
							<CardContent>
								{isProvider && (
									<div className='grid grid-cols-2 gap-3 mb-6 text-sm'>
										{["Verify contact", "Business profile", "Services offered", "Availability"].map((item, i) => (
											<div
												key={i}
