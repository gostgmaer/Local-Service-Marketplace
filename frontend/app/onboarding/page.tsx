    ...
    try {
      ...
      await Promise.all(
        selectedCategories.map((catId) =>
          apiClient
            .post(`/providers/${provider.id}/services`, { category_id: catId })
            .catch(() => null),
        ),
      );
    ...
    try {
      ...
      await Promise.all(
        availability.map((slot) =>
          apiClient
            .post(`/providers/${provider.id}/availability`, {
            ...
            <div className="flex items-start gap-3 rounded-lg border border-amber-300 bg-amber-50 dark:bg-amber-900/20 dark:border-amber-700 p-4 mb-6 text-sm">
              ...
              <div>
                ...
                <p className="text-amber-700 dark:text-amber-400 mt-0.5">
                  You need to verify your email or phone before you can access
                  provider features. Please complete the steps below.
                </p>
              </div>
            </div>
          )}
            ...
            <div className="flex items-start gap-3 rounded-lg border border-blue-300 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-700 p-4 mb-6 text-sm">
              ...
              <div>
                ...
                <p className="text-blue-700 dark:text-blue-400 mt-0.5">
                  Your account is pending admin approval. You will be able to
                  submit proposals and access provider features once your
                  account has been verified. This usually takes 1–2 business
                  days.
                </p>
              </div>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  You must verify your email or phone number before you can
              ...
              <CardContent className="space-y-4">
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <Mail
                      className={`h-5 w-5 flex-shrink-0 ${emailVerified ? "text-green-600" : "text-amber-600"}`}
                    />
                  ...
                  {!emailVerified && (
                    <div className="mt-3 space-y-2">
                      <p className="text-xs text-amber-700 dark:text-amber-300">
                        A verification link was sent when you registered. Check
                ...
                >
                  <div className="flex items-center gap-3">
                    <Phone
                      className={`h-5 w-5 flex-shrink-0 ${phoneVerified ? "text-green-600" : "text-gray-400"}`}
                    />
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900 dark:text-white">
                        Phone Number
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {phoneVerified
                          ? "Verified via OTP"
                          : "Not yet verified — you can verify from Settings later"}
                      </p>
                    </div>
                    {phoneVerified && (
                      <span className="flex items-center gap-1 text-xs font-medium text-green-700 dark:text-green-400">
                ...
                {!contactVerified && (
                  <div className="flex items-start gap-2 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-3 text-xs text-red-700 dark:text-red-300">
                    ...
                    <span>
                      You must verify your email or phone before continuing.
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      Your GST Identification Number for tax invoices
                    </p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
            ...
            <Card>
              <CardHeader>
                <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                  <Clock className="h-5 w-5 text-primary-600" /> Set Your
                  Availability
                </h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        {active && (
                          <div className="flex items-center gap-2 text-sm">
                            <input
                              ...
                              onChange={(e) =>
                                updateSlot(day, "start_time", e.target.value)
                              }
                            ...
                            <input
                              ...
                              value={slot.end_time}
                              onChange={(e) =>
                                updateSlot(day, "end_time", e.target.value)
                              }
                              className="px-2 py-1 border border-gray-300 dark:border-gray-600 rounded dark:bg-gray-800 dark:text-white text-xs"
                            />
                          </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 rounded-lg border border-amber-300 bg-amber-50 dark:bg-amber-900/20 dark:border-amber-700 p-4">
                      ...
                      <div className="text-sm">
                        ...
                        <p className="text-amber-700 dark:text-amber-400">
                          Your profile is under review by our team. You will be
                          notified once verified. Until then you can browse
                          requests and prepare proposals, but you cannot accept
                          jobs or receive payments.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg border border-blue-200 dark:border-blue-700 bg-blue-50 dark:bg-blue-900/20 p-4 text-sm text-blue-800 dark:text-blue-300">
                      ...
                      <ul className="space-y-1 list-disc list-inside text-xs">
                        ...
                        <li>
                          Submit proposals on relevant jobs (held until
                          verified)
                        </li>
