...
const ALL_NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    icon: FileText,
    permissions: [Permission.REQUESTS_CREATE, Permission.REQUESTS_READ],
    roles: ["customer"],
  },
  {
    label: "My Jobs",
    ...
    icon: Briefcase,
    permissions: [Permission.JOBS_READ],
  ...
  },
  {
    ...
    icon: Heart,
    permissions: [Permission.FAVORITES_MANAGE],
    roles: ["customer"],
  },
  {
    label: "Payment History",
    href: ROUTES.DASHBOARD_PAYMENT_HISTORY,
    icon: CreditCard,
  ...
  {
    label: "My Reviews",
    href: ROUTES.DASHBOARD_REVIEWS,
    icon: Star,
    permissions: [Permission.REVIEWS_CREATE, Permission.REVIEWS_READ],
    roles: ["customer"],
  },
  {
    label: "My Disputes",
    ...
    icon: MessagesSquare,
    permissions: [Permission.DISPUTES_FILE, Permission.DISPUTES_READ],
    roles: ["customer", "provider"],
  },
  ...
  // ── Provider items ─────────────────────────────────────────────────────
  {
    ...
    icon: Search,
    permissions: [Permission.REQUESTS_BROWSE],
    roles: ["provider"],
  },
  {
    label: "My Proposals",
    ...
    icon: ClipboardList,
    permissions: [Permission.PROPOSALS_CREATE, Permission.PROPOSALS_READ],
    roles: ["provider"],
  },
  {
    label: "Earnings",
    ...
    icon: IndianRupee,
    permissions: [Permission.EARNINGS_VIEW],
    roles: ["provider"],
  },
  {
    label: "Availability",
    ...
    icon: Clock,
    permissions: [Permission.PROVIDER_AVAILABILITY_MANAGE],
    roles: ["provider"],
  },
  {
    label: "My Profile",
    href: ROUTES.DASHBOARD_PROVIDER_OVERVIEW,
    icon: Star,
    permissions: [Permission.PROVIDER_PROFILE_VIEW],
    roles: ["provider"],
  },
  {
    label: "Services",
    href: ROUTES.DASHBOARD_PROVIDER_SERVICES,
    icon: Tag,
    permissions: [Permission.PROVIDER_SERVICES_MANAGE],
    roles: ["provider"],
  },
  {
    label: "Portfolio",
    href: ROUTES.DASHBOARD_PROVIDER_PORTFOLIO,
    icon: FolderOpen,
    permissions: [Permission.PROVIDER_PORTFOLIO_MANAGE],
    roles: ["provider"],
  },
  {
    label: "Documents",
    href: ROUTES.DASHBOARD_PROVIDER_DOCUMENTS,
    icon: FileText,
    permissions: [Permission.PROVIDER_DOCUMENTS_MANAGE],
    roles: ["provider"],
  },
  {
    label: "Reviews",
    href: ROUTES.DASHBOARD_PROVIDER_REVIEWS,
    icon: Star,
    permissions: [Permission.REVIEWS_READ],
    roles: ["provider"],
  },
  ...
  {
    label: "Providers",
    href: ROUTES.DASHBOARD_ADMIN_PROVIDERS,
    icon: Shield,
    permissions: [Permission.PROVIDERS_LIST, Permission.PROVIDERS_VERIFY],
    roles: ["admin"],
  },
  {
    label: "Categories",
    href: ROUTES.DASHBOARD_ADMIN_CATEGORIES,
    icon: Tag,
  ...
  {
    label: "Disputes",
    href: ROUTES.DASHBOARD_ADMIN_DISPUTES,
    icon: AlertTriangle,
    permissions: [Permission.DISPUTES_MANAGE],
    roles: ["admin"],
  },
  {
    label: "Analytics",
    href: ROUTES.DASHBOARD_ADMIN_ANALYTICS,
    icon: BarChart3,
  ...
  {
    label: "Audit Logs",
    href: ROUTES.DASHBOARD_ADMIN_AUDIT_LOGS,
    icon: Scroll,
  ...
  },
  {
    ...
    href: ROUTES.DASHBOARD_ADMIN_ROLES,
    icon: Shield,
    ...
    >
      ...
      {!isCollapsed && (
        <>
          ...
          {isActive && (
            <span className="h-1.5 w-1.5 rounded-full bg-primary-500 dark:bg-primary-400 flex-shrink-0" />
          )}
        </>
      )}
    </Link>
