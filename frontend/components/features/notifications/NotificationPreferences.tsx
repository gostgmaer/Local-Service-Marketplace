...
export function NotificationPreferences() {
  ...
  const hasChanges = () => {
    ...
    return PREFERENCE_SETTINGS.some(
      (setting) => localPreferences[setting.key] !== preferences[setting.key],
    );
  };
  ...
  const activitySettings = PREFERENCE_SETTINGS.filter(
    (s) => s.category === "activities",
  );
        ...
        <div className="bg-white rounded-lg shadow-md">
                ...
                >
                  ...
                  <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                    <input
                      ...
                      onChange={(e) =>
                        updatePreference(setting.key, e.target.checked)
                      }
          ...
          <div className="p-6 bg-blue-50 border-t border-blue-200">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> We recommend keeping payment and job
              updates enabled to stay informed about important activities on
              your account.
            </p>
          </div>
        </div>
