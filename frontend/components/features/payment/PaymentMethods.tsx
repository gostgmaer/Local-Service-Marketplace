        ...
        <div className="bg-white rounded-lg shadow-md">
          ...
          <div className="p-4 bg-green-50 border-b border-green-200 flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-green-800">
                <strong>Secure Storage:</strong> Your payment information is
                encrypted and securely stored. We never store your full card
                number.
              </p>
            </div>
          </div>
          ...
          <div className="p-6 bg-blue-50 border-t border-blue-200">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Your default payment method will be used
              for automatic payments and quick checkout. You can change it
              anytime.
            </p>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="p-8 text-center text-gray-600">
                ...
                <p className="mb-4">
                  Payment method integration with Stripe, PayPal, or other
                  payment gateways would be implemented here.
                </p>
                <p className="text-sm">
                  This requires connecting to your payment gateway's SDK and
