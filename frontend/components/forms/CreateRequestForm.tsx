...
const URGENCY_OPTIONS = [
  {
    value: "low",
    label: "Flexible",
    desc: "Anytime in the next few weeks",
  ...
  },
  {
    value: "urgent",
    label: "ASAP",
    desc: "Within 24 hours if possible",
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  {URGENCY_OPTIONS.map((opt) => (
                    ...
                    >
                      ...
                      <div>
                        <p className={cn("text-sm font-semibold", opt.color)}>
                          {opt.label}
                        </p>
        ...
        {step === 3 && (
          <Card elevated>
            <CardHeader>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                Help providers know if they serve your area
              </p>
            </CardHeader>
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500 flex items-center gap-1.5">
                ...
                Location is only shared with providers you contact. You can skip
                this step.
              </p>
            </CardContent>
          </Card>
        ...
        {step === 4 && (
          <Card elevated>
            <CardHeader>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                Confirm everything looks good before posting
              </p>
            </CardHeader>
            <CardContent className="p-6 space-y-4">
              <div className="rounded-xl border border-gray-100 dark:border-gray-800 divide-y divide-gray-100 dark:divide-gray-800">
                ...
                {budgetNum > 0 && (
                  ...
                  value={
                    URGENCY_OPTIONS.find(
                      (o) => o.value === watchedValues.urgency,
                    )?.label ?? "—"
                  }
                />
                {watchedValues.preferred_date && (
                  <ReviewRow
                    ...
                    value={watchedValues.preferred_date}
                  />
                )}
