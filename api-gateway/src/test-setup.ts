...
process.env.MARKETPLACE_SERVICE_URL =
  process.env.MARKETPLACE_SERVICE_URL || "http://localhost:3003";
...
process.env.OVERSIGHT_SERVICE_URL =
  process.env.OVERSIGHT_SERVICE_URL || "http://localhost:3010";
process.env.INFRASTRUCTURE_SERVICE_URL =
  process.env.INFRASTRUCTURE_SERVICE_URL || "http://localhost:3012";
process.env.FILE_UPLOAD_SERVICE_URL =
  process.env.FILE_UPLOAD_SERVICE_URL || "http://localhost:4100";
process.env.GATEWAY_INTERNAL_SECRET =
  process.env.GATEWAY_INTERNAL_SECRET || "test-gateway-secret";
