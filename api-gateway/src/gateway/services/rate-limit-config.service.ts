      ...
      if (data) {
        this.config = {
          rate_limit_max_requests:
            data.rate_limit_max_requests ?? this.config.rate_limit_max_requests,
          auth_rate_limit_max_requests:
            data.auth_rate_limit_max_requests ??
            this.config.auth_rate_limit_max_requests,
          rate_limit_window_ms:
            data.rate_limit_window_ms ?? this.config.rate_limit_window_ms,
        };
      }
    } catch {
